...
$innosetup = 'tacticalagent-v2.4.8-windows-amd64.exe'
...
$downloadlink = 'https://github.com/amidaware/rmmagent/releases/download/v2.4.8/tacticalagent-v2.4.8-windows-amd64.exe'
